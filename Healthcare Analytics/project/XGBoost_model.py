...
# # ################## in case used cross Validation & evaluate model
# cv_result = cross_validate(xgb_clf, x_train, y_train, cv=10, return_train_score=True)
# print(cv_result)
# print(cv_result['test_score'].mean())
# y_pred = cross_val_predict(xgb_clf, x_test, y_test, cv=10)
